# Standard S-007 — Genius Guides Format
...
Defines the ten educational artifacts auto-generated into `.umt/Genius Guides/.CmdGenius/` — Hardware Wiring, Algorithm, Flowchart, Pseudocode, Architecture Diagram, App Guide, API Reference, Testing Guide, Performance Report, Debug Guide.
...
An implementation conforms to Standard S-007 if and only if:
...
`errata` and `s-007`. Errata that require a normative change trigger
